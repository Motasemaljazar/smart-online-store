...
REM Extract file name from URL
...
REM Gradle archives extract to a folder like "gradle-8.7". Derive that.
...
REM Download distribution if needed.
...
REM Extract distribution if needed.
